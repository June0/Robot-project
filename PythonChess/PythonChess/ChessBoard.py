...
class ChessBoard:
	...
	def MovePiece(self,moveTuple):
		...
		if toPiece == 'e':
			messageString = fromPiece_fullString+ " passe de "+self.ConvertToAlgebraicNotation(moveTuple[0])+\
			...
			messageString = fromPiece_fullString+ " de "+self.ConvertToAlgebraicNotation(moveTuple[0])+\
						" capture "+toPiece_fullString+" en "+self.ConvertToAlgebraicNotation(moveTuple[1])+"!"
		...
		#tts = ALProxy("ALTextToSpeech", "169.254.28.144", 9559)
		#tts.say(messageString)
